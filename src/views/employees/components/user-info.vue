  ...
  <div class="user-info">
    ...
    <el-form label-width="220px">
      ...
      <el-row class="inline-info" type="flex" justify="center">
        <el-col :span="12">
          <el-button type="primary" @click="saveUserDetailInfo">保存更新</el-button>
    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="员工照片">
          <!-- 放置上传图片 -->
          <uploadImg ref="employeesPic" :default-url="EmployeesPic" @on-success="uploadPicSuccess" />
        </el-form-item>
...
import { getUserDetailById, getEmployeesInfo, saveEmployeesInfo, saveUserDetailById } from '@/api'
export default {
  data() {
    return {
